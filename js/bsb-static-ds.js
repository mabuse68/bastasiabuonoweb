 ...
 * @constructor
 */
function BsBDataSource() {
  $.extend(this, new storeLocator.StaticDataFeed);

  var that = this;
  $.get('bsb-points.csv', function(data) {
 ...
 */
BsBDataSource.prototype.getFeatures = function() {
 ...
 */
BsBDataSource.prototype.parse_ = function(csv) {
  var stores = [];
  var rows = csv.split('\n');
 ...
 * @return {string}
 */
BsBDataSource.prototype.join_ = function(arr, sep) {
  var parts = [];
 ...
 * @return {Array.<string>}
 */
BsBDataSource.prototype.parseRow_ = function(row) {
  // Strip leading quote.
  if (row.charAt(0) == '"') {
    row = row.substring(1);
  }
 ...
 * @return {Object}
 */
BsBDataSource.prototype.toObject_ = function(headings, row) {
  var result = {};
